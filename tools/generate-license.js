...
//
// 사용법 예시:
//   node tools/generate-license.js --tier=premium --devices=2 --days=90
...
const payload = { tier, maxDevices, expiresAt, issuedAt, licenseId };
const key = signPayload(payload, privateKeyPem);

console.log('발급 내역');
console.log('  등급        :', tier === 'premium' ? '프리미엄' : '스탠다드');
console.log('  최대 기기 수:', maxDevices, '대');
